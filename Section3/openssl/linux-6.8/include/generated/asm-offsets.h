...
#define TASK_threadsp 9304 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 2472 /* offsetof(struct task_struct, stack_canary) */
...
#define ARIA_CTX_enc_key 0 /* offsetof(struct aria_ctx, enc_key) */
#define ARIA_CTX_dec_key 272 /* offsetof(struct aria_ctx, dec_key) */
#define ARIA_CTX_rounds 544 /* offsetof(struct aria_ctx, rounds) */
